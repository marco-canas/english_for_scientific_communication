# Programa del curso de inglés para desarrollo de las capacidades de comunicación científica en matemáticas y ciencia de datos con python  
...
# Programa de clases por temas y semanas  
...
- **Semana 1-2:** Presente simple (verbos *be*, *have*, *solve*)  
  - Vocabulario: Números (decimals, fractions), operaciones (*add*, *subtract*, *equals*).  
  - Práctica: Traducir 5 problemas aritméticos diarios (ej: *"If x plus 3 equals 10, find x"*).  
- **Semana 3-4:** Verbos modales (*can*, *must*) + Comparativos  
  - Vocabulario: Formas geométricas (*sphere*, *acute angle*), comparar figuras (*"A square has more sides than a triangle"*).  
  - Práctica: Describir gráficos de barras simples (usando *increase*, *decrease*).  

#### **Mes 2: Vocabulario STEM + Frases Clave**  
- **Semana 5-6:** Vocabulario de álgebra (*equation*, *variable*, *polynomial*).  
  - Práctica: Escribir ecuaciones en inglés y resolverlas paso a paso.  
...
**Recursos Semanales:**  
- **Videos:** *"Math Vocabulary in English"* (American English).  
- **Apps:** Duolingo (sección *STEM*).  
...
- **Semana 13-14:** Pasado simple (*"Pythagoras proved his theorem in..."*) + Vocabulario de historia de las matemáticas.  
  - Práctica: Redactar la biografía de un matemático famoso.  
...
- **Semana 19-20:** Frases para debates (*"Let’s verify this hypothesis"*).  
  - Práctica: Simular una discusión sobre métodos de solución.  

#### **Mes 6: Consolidación + Evaluación B1**  
- **Semana 21-22:** Redactar problemas matemáticos en inglés (ej: *"Prove by induction that..."*).  
- **Semana 23-24:** Mock exam B1 (usando recursos de *That’s English!*).  

**Recursos Semanales:**  
- **MOOC:** *"English for STEM"* (Univ. Pennsylvania, Coursera).  
- **Juegos:** *Trace Effects* (niveles científicos).  
...
- **Semana 25-26:** Condicionales (*"If we differentiate, we obtain..."*) + Vocabulario de cálculo (*derivative*, *integral*).  
  - Práctica: Explicar un problema hipotético (ej: *"What would happen if...?"*).  
...
- **Lunes-Viernes:**  
  ...
  - 20 min: Práctica oral (explicar un concepto a un "estudiante imaginario").  
